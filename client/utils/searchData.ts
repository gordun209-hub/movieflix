...
export const SearchSeriesResults: SearchSeriesResults = {
	...
	results: [
		...
		},
		{
			id: 'tt14609588',
			resultType: 'Title',
			image: 'https://imdb-api.com/images/original/MV5BMmU5ZTRmZmEtYjA1Ny00NzRlLWIyODItZWQ4NDlkYzFmNDYyXkEyXkFqcGdeQXVyNDY5MjMyNTg@._V1_Ratio0.7273_AL_.jpg',
			title: 'Lost',
		...
		},
		{
			id: 'tt5232792',
			resultType: 'Title',
			image: 'https://imdb-api.com/images/original/MV5BYzZkOTY4MDgtODI5Mi00ZjA4LWJkODgtYzBiOGE3MWNhZWFmXkEyXkFqcGdeQXVyMTkxNjUyNQ@@._V1_Ratio0.7273_AL_.jpg',
			title: 'Lost in Space',
		...
		},
		{
			id: 'tt11379026',
			resultType: 'Title',
			image: 'https://imdb-api.com/images/original/MV5BMzRlOTdiNGEtOTlmZi00YjNiLTljZjItZGNhNjY5ZDM4Yzg2XkEyXkFqcGdeQXVyNjc0MjkzNjc@._V1_Ratio0.7273_AL_.jpg',
			title: 'Ghosts',
			description: '(2021) (TV Series)'
		}
	],
...
export const SearchNameResults = {
	...
	results: [
		...
		},
		{
			id: 'nm0719756',
			resultType: 'Name',
			image: 'https://imdb-api.com/images/original/MV5BMjA0NjI0MTIwNF5BMl5BanBnXkFtZTYwNTY0MjI2._V1_Ratio1.4545_AL_.jpg',
			title: 'Jean Renoir',
	...
	results: [
		{
			id: 'tt0923499',
			resultType: 'Title',
			image: 'https://imdb-api.com/images/original/MV5BYmJlZTYxMTgtNmJjNi00ZTQwLWI2ODItOGUyNTY0YjhiYTYzXkEyXkFqcGdeQXVyMTAxMjIzNTQ5._V1_Ratio1.2273_AL_.jpg',
			title: 'London',
			description: '(1983) (TV Episode) - Season 1 | Episode 7 - Treasure Hunt (1982) (TV Series)'
		},
		{
			id: 'tt13267258',
			resultType: 'Title',
			image: 'https://imdb-api.com/images/original/MV5BZmRlNzI5NWQtMTUwOS00ZWMwLWFkZTQtYTEyMTEwZTM4YjliXkEyXkFqcGdeQXVyNDc3NzQwMzc@._V1_Ratio0.7273_AL_.jpg',
			title: 'London',
			description: '(2020) (TV Episode) - Season 1 | Episode 3 - #Travel (2020) (TV Series)'
		},
		{
			id: 'tt12967650',
			resultType: 'Title',
			image: 'https://imdb-api.com/images/original/MV5BYmM1OTg0YTktZTI5NC00MGExLTg0ZWQtYjcyNDgzNTU1YzI5XkEyXkFqcGdeQXVyNjExODE1MDc@._V1_Ratio1.3182_AL_.jpg',
			title: 'London',
			description: '(2008) (TV Episode) - Le dessous des cartes (1990) (TV Series)'
		}
	],
	errorMessage: ''
}
...
export const searchAllResults = {
	...
	results: [
		...
		},
		{
			id: 'tt3022202',
			resultType: 'Title',
			image: 'https://imdb-api.com/images/original/MV5BMTgyMTcyNDE1OF5BMl5BanBnXkFtZTgwODQ2Njk3MDE@._V1_Ratio0.7273_AL_.jpg',
			title: 'Inception',
			description: '(2010) (TV Episode) - Season 4 | Episode 53 - Zoom In (2008) (TV Series)'
		},
		{
			id: 'tt1790736',
			resultType: 'Title',
		...
		},
		{
			id: 'tt5295990',
			resultType: 'Title',
			image: 'https://imdb-api.com/images/original/MV5BZGFjOTRiYjgtYjEzMS00ZjQ2LTkzY2YtOGQ0NDI2NTVjOGFmXkEyXkFqcGdeQXVyNDQ5MDYzMTk@._V1_Ratio0.7273_AL_.jpg',
			title: 'Inception: Jump Right Into the Action',
			description: '(2010) (Video)'
		}
	],
