...
export const { showActors, hideActors, showPosters, hidePosters, showBoxOffice, hideBoxOffice } =
	contentToShowSlice.actions

export const selectShowActors = (state: RootState) => state.contentToShow.showActors
export const selectShowPosters = (state: RootState) => state.contentToShow.showPosters
export const selectShowBoxOffice = (state: RootState) => state.contentToShow.showBoxOffice
